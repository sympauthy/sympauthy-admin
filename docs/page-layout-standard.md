...
**A record's route carries the breadcrumb for every tab under it**, and redirects to the first tab
every one of its records has, so the URL always names a view.
