...
import { UserProviderLinkApi } from '@/entities/user/api/UserProviderLinkApi'
import type { UserProviderLinkResource } from '@/entities/user/model/UserProviderLinkResource'
